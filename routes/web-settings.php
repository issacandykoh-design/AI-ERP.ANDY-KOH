...
use App\Http\Controllers\MenuCustomizationController;
...
Route::group(['middleware' => 'auth', 'prefix' => 'account/settings'], function () {
    ...
    Route::post('language-settings/ai-translate', [LanguageSettingController::class, 'aiTranslateLanguage'])->name('language_settings.ai_translate');
    Route::post('language-settings/test-ai-translation', [LanguageSettingController::class, 'testAiTranslation'])->name('language_settings.test_ai_translation');
    Route::get('language-settings/{id}/translation-progress', [LanguageSettingController::class, 'getTranslationProgress'])->name('language_settings.translation_progress');
    ...
    // Menu Customization
    Route::get('menu-customization', [\App\Http\Controllers\MenuCustomizationController::class, 'index'])->name('menu-customization.index');
    Route::post('menu-customization/save-all', [\App\Http\Controllers\MenuCustomizationController::class, 'saveAll'])->name('menu-customization.save-all');
    Route::post('menu-customization/update', [\App\Http\Controllers\MenuCustomizationController::class, 'update'])->name('menu-customization.update'); // Deprecated, kept for backward compatibility
    Route::post('menu-customization/reorder', [\App\Http\Controllers\MenuCustomizationController::class, 'reorder'])->name('menu-customization.reorder'); // Deprecated
    Route::post('menu-customization/toggle-visibility', [\App\Http\Controllers\MenuCustomizationController::class, 'toggleVisibility'])->name('menu-customization.toggle-visibility'); // Deprecated
    Route::post('menu-customization/reset-visibility', [\App\Http\Controllers\MenuCustomizationController::class, 'resetVisibility'])->name('menu-customization.reset-visibility');
    Route::post('menu-customization/reset-all', [\App\Http\Controllers\MenuCustomizationController::class, 'resetAll'])->name('menu-customization.reset-all');
    Route::post('menu-customization/apply-global-default-all', [\App\Http\Controllers\MenuCustomizationController::class, 'applyGlobalDefaultAll'])->name('menu-customization.apply-global-default-all');
    Route::get('menu-customization/progress', [\App\Http\Controllers\MenuCustomizationController::class, 'progress'])->name('menu-customization.progress');

    // Custom Modules
    Route::post('custom-modules/deleteFile', [CustomModuleController::class, 'deleteFile'])->name('custom-modules.deleteFile');

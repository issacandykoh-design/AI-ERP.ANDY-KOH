...
use App\Http\Controllers\SuperAdmin\ModuleSwitchController;
...
use App\Http\Controllers\SuperAdmin\FrontSetting\AiSettingController;
use App\Http\Controllers\SuperAdmin\FrontSetting\ThemeSettingController as FrontThemeSettingController;
use App\Http\Controllers\SuperAdmin\TelescopeDashboardController;
...
Route::group(['middleware' => ['auth', 'super-admin'], 'prefix' => 'account', 'as' => 'superadmin.'], function () {
    ...
    Route::group(['middleware' => 'auth', 'prefix' => 'settings', 'as' => 'settings.'], function () {
        ...
        // Module Switch routes
        Route::get('module-switch', [ModuleSwitchController::class, 'index'])->name('module-switch.index');
        Route::post('module-switch/toggle-status', [ModuleSwitchController::class, 'toggleStatus'])->name('module-switch.toggle-status');
        Route::post('module-switch/bulk-toggle', [ModuleSwitchController::class, 'bulkToggle'])->name('module-switch.bulk-toggle');
        Route::get('module-switch/{id}', [ModuleSwitchController::class, 'show'])->name('module-switch.show');
        ...
        Route::post('ai-settings/update-api-key', [AiSettingController::class, 'updateApiKey'])->name('ai-settings.update_api_key');
        Route::post('ai-settings/switch-llm', [AiSettingController::class, 'switchLlm'])->name('ai-settings.switch_llm');
        Route::get('ai-settings/refresh-token-usage', [AiSettingController::class, 'refreshTokenUsage'])->name('ai-settings.refresh_token_usage');
        Route::get('ai-settings/token-usage', [AiSettingController::class, 'getTokenUsage'])->name('ai-settings.token_usage');
        Route::post('ai-settings/test-connection', [AiSettingController::class, 'testConnection'])->name('ai-settings.test_connection');
...
Route::group(['middleware' => ['auth', 'admin-or-super-admin'], 'prefix' => 'account', 'as' => 'superadmin.'], function () {
    ...
    Route::get('telescope-dashboard', [TelescopeDashboardController::class, 'index'])->name('telescope.dashboard');
});

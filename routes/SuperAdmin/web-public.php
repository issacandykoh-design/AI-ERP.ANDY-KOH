...
// Serve the marketing landing page before ERP login (respects superadmin CMS settings)
// This route uses FrontendController which respects theme settings (Theme 1, Theme 2, or Theme 3)
Route::middleware('web')->get('/', [FrontendController::class, 'index'])->name('front.home');

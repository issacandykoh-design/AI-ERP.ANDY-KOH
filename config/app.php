...
return [
    ...
    */
    ...
    // This will determine if the application craveva or craveva-saas
    'app_name' => 'craveva-saas',

    'name' => 'craveva Saas',


    // We will use this for email copyright message
    'global_app_name' => 'craveva Saas',
    /*
    |--------------------------------------------------------------------------
    | Application Name
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'show_language_flags' => env('SHOW_LANGUAGE_FLAGS', true),

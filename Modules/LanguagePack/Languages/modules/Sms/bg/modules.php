...
return [
  ...
  'notificationConfigure' => 'Изборът на известия и присвояването на компаниите се управляват от администраторския панел, а не от супер администраторския панел.',
];

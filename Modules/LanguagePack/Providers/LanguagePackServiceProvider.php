...
class LanguagePackServiceProvider extends ServiceProvider
{
    ...
    {
        require_once module_path('LanguagePack', 'start.php');
    ...
    public function registerViews()
    {
        ...
        $this->loadViewsFrom(array_merge($this->getPublishableViewPaths(), [$sourcePath]), 'languagepack');
    }
    ...
    private function getPublishableViewPaths(): array
    {
        ...
        foreach (\Config::get('view.paths') as $path) {
            if (is_dir($path . '/modules/languagepack')) {
                $paths[] = $path . '/modules/languagepack';
            }
        }

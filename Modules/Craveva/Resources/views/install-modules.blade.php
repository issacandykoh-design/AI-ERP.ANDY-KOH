@if(count(getCravevaAvailableForInstallModules()) > 0)
<div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 px-0 pb-4">
    <h4 class="f-21 font-weight-normal">
        @lang('craveva::app.installBundleModules')
    </h4>

</div>
<div class="col-md-12 mb-3 px-0">
    <ul class="list-group" id="files-list">
        @foreach (getCravevaAvailableForInstallModules() as $module)
        <li class="list-group-item">
            <div class="row">
                ...
                <div class="col-lg-3 text-lg-right py-1">
                    <button type="button"
                            class="btn btn-primary p-1 f-13 btn-sm mr-2 installCravevaModule"
...
<script>
$('body').on('click', '.installCravevaModule', function() {
        var module = $(this).data('module');


        var alertMessage = `@lang('craveva::app.installModuleConfirm', ['module' => ':module'])`;

    ...
    public function up()
    {
        ...
        if (! Schema::hasColumn('recruit_job_applications', 'recruit_job_id')) {
            Schema::table('recruit_job_applications', function (Blueprint $table) {
                ...
                try { $table->foreign('recruit_job_id')->references('id')->on('recruit_jobs')->onUpdate('cascade')->onDelete('cascade'); } catch (\Throwable $e) {}
                try { $table->dropForeign('recruit_job_applications_job_id_foreign'); } catch (\Throwable $e) {}
                ...
                try { $table->foreign('recruit_application_status_id')->references('id')->on('recruit_application_status')->onUpdate('cascade')->onDelete('cascade'); } catch (\Throwable $e) {}
                try { $table->dropForeign('recruit_job_applications_status_id_foreign'); } catch (\Throwable $e) {}

                DB::statement('ALTER TABLE `recruit_job_applications` CHANGE `source_id` `application_source_id` INT UNSIGNED NULL DEFAULT NULL;');
                try { $table->foreign('application_source_id')->references('id')->on('application_sources')->onDelete('cascade')->onUpdate('cascade'); } catch (\Throwable $e) {}
                try { $table->dropForeign('recruit_job_applications_source_id_foreign'); } catch (\Throwable $e) {}

                DB::statement('ALTER TABLE `recruit_job_applications` CHANGE `file_id` `recruit_job_file_id` INT UNSIGNED NULL DEFAULT NULL;');
                try { $table->foreign('recruit_job_file_id')->references('id')->on('recruit_job_files')->onDelete('cascade')->onUpdate('cascade'); } catch (\Throwable $e) {}
                try { $table->dropForeign('recruit_job_applications_file_id_foreign'); } catch (\Throwable $e) {}
            });
        }

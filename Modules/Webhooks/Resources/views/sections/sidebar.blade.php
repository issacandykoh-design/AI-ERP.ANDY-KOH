@if (in_array(\Modules\Webhooks\Entities\WebhooksGlobalSetting::MODULE_NAME, user_modules()) && (user()->permission('view_webhooks') == 'all' || user()->permission('view_webhooks_logs') == 'all'))
<x-menu-item icon="wallet" :text="__('webhooks::app.webhooks')" :addon="App::environment('demo')" menu-key="webhooks">
    ...
    <div class="accordionItemContent pb-2">
        @if (user()->permission('view_webhooks') == 'all')

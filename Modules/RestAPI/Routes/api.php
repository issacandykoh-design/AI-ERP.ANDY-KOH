...
ApiRoute::group(['namespace' => 'Modules\RestAPI\Http\Controllers', 'prefix' => ''], function () {
...
ApiRoute::group(['namespace' => 'Modules\RestAPI\Http\Controllers', 'middleware' => ['auth:sanctum', 'api.auth'], 'prefix' => ''], function () {

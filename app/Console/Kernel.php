...
use App\Console\Commands\SendDailyTaskChangeReport;
...
use App\Console\Commands\SetupVerify;
use DateTimeZone;
...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        SendDailyTaskChangeReport::class,
    ...
    protected function schedule(Schedule $schedule)
    {
        ...
        $schedule->command('send-daily-task-change-report')->dailyAt('02:35');

...
use App\Models\PackageAICredit;
...
class Package extends BaseModel
{
    ...
    {
        return \Database\Factories\SuperAdmin\PackageFactory::new();
    }
    ...
    public function packageAICredits(): HasMany
    {
        return $this->hasMany(PackageAICredit::class, 'package_id');
    }

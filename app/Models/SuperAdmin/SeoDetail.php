...
class SeoDetail extends BaseModel
{
    ...
    {
        return ($this->og_image) ? asset_url_local_s3('front/seo-detail/' . $this->og_image) : null;
    }
    ...
    public function maskedOgImageUrl(): Attribute
    {
        return Attribute::make(
            get: function () {
                return ($this->og_image) ? $this->generateMaskedImageAppUrl('front/seo-detail/' . $this->og_image) : null;
            },
        );

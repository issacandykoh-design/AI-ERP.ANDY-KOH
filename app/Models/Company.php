...
class Company extends BaseModel
{
    ...
    public $dates = [
        'last_login',
        'subscription_updated_at', // cravevaSAAS
        'licence_expire_on' // cravevaSAAS
    ];
    ...
    // AI Credits and Module Marketplace Relationships
    public function aiCredits(): HasOne
    {
        return $this->hasOne(CompanyAICredit::class, 'company_id');
    }

    public function moduleSubscriptions(): HasMany
    {
        return $this->hasMany(CompanyModuleSubscription::class, 'company_id');
    }

    public function aiCreditPurchases(): HasMany
    {
        return $this->hasMany(AICreditPurchase::class, 'company_id');
    }

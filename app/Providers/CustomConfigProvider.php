...
class CustomConfigProvider extends ServiceProvider
{
    ...
    {
        // Always load SMTP settings from database regardless of APP_ENV
        // This allows dynamic configuration without hardcoding environment values
        ...
        // Set authentication mode and local domain to prevent relay errors
        Config::set('mail.mailers.smtp.auth_mode', 'login');
        Config::set('mail.mailers.smtp.local_domain', $setting->mail_host);

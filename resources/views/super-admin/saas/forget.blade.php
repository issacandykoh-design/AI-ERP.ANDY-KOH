...
<head>
    ...
    <link href="{{ asset('front/plugin/craveva-helper/helper.css') }}" rel="stylesheet">
    <!-- Template CSS -->
    <link type="text/css" rel="stylesheet" media="all" href="{{ asset('saas/css/main.css') }}">
    <!-- Template Font Family - Using Helvetica Neue (consistent with main app) -->
    <link type="text/css" rel="stylesheet" media="all"
        ...
        <div class="login-box mt-5 shadow bg-white form-section">
            ...
            <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                    <div class="col-xs-12">
                        <input class="form-control" id="password" type="password" name="password" required="" placeholder="@lang('app.password')">
...
<script src="{{ asset('front/plugin/craveva-helper/helper.js') }}"></script>

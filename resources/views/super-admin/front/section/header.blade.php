    ...
    <div class="container-wide">
        ...
        <div class="row h-full align-items-center text-center text-lg-left">
            ...
            <div class="col-12 col-lg-6 offset-lg-1 img-outside-right hidden-md-down">
                <div class="shadow-4 mt-80 d-flex align-items-center justify-content-center" style="height: 300px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px;">
                    <h1 class="text-white font-weight-bold" style="font-size: 3rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">Craveva</h1>
                </div>
            </div>
        </div>

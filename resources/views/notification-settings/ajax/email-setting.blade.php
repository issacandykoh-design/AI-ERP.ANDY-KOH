            ...
            @if ($smtpSetting->mail_driver == 'smtp')
                ...
                @else
                    ...
                    <x-alert type="secondary" icon="info-circle">
                        ...
                        <ul>
                            <li class="py-2">1. <a href="https://get.smtp2go.com/craveva" target="_blank">SMTP2GO.COM</a></li>
                            <li>2. <a href="https://pstk.smtp.com/craveva" target="_blank">SMTP.COM</a></li>
                        </ul>
                    </x-alert>
                @endif

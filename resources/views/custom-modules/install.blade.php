                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <x-forms.file-multiple
                            ...
                            :fieldLabel=" __('messages.downloadFilefromcraveva') " fieldName="file"
...
@push('scripts')
    <script>
        ...
        $(document).ready(function () {
            const uploadFile = "{{ route('custom-modules.store') }}?_token={{ csrf_token() }}";
        ...
        $('.delete-files').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.easyAjax({
                        type: 'POST',
                        url: "{{ route('custom-modules.deleteFile') }}",
                        blockUI: true,
                        data: {
                            "_token": "{{ csrf_token() }}",
                            filePath: filePath

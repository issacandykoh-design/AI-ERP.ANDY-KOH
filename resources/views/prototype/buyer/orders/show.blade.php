...
@section('title', 'Order Details - B2B Marketplace')
...
<div class="container my-5">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>John Doe<br>ABC Restaurant<br>123 Main Street<br>Singapore 123456</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex gap-2">
        <a href="/prototype/buyer/orders" class="btn btn-outline-secondary">Back to Orders</a>

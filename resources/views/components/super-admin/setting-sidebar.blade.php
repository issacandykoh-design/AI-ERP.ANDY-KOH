...
<div class="settings-sidebar bg-white py-3" id="mob-settings-sidebar">
    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        @endif
        @if (user()->permission('manage_superadmin_language_settings') == 'all' || user()->is_superadmin)
        ...
        @endif
        <x-setting-menu-item :active="$activeMenu" menu="menu_customization"
                             :href="route('menu-customization.index')"
                             :text="__('app.menu.menuCustomization')"/>
        ...
        <x-setting-menu-item :active="$activeMenu" menu="module_switch"
                             :href="route('superadmin.settings.module-switch.index')"
                             :text="__('app.menu.moduleSwitch')"/>
        @endif

        @if (user()->permission('manage_superadmin_front_settings') == 'all')
        <x-setting-menu-item :active="$activeMenu" menu="ai_settings"
                             :href="route('superadmin.settings.ai-settings.index')"
                             :text="__('superadmin.menu.aiSettings')"/>
        @endif

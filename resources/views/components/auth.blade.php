...
<head>
    @php($globalSetting = $globalSetting ?? global_setting())
    @php($languages = $languages ?? language_setting())
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <!-- Template CSS -->
    <link href="{{ asset('vendor/craveva-helper/helper.css') }}" rel="stylesheet" defer="defer">

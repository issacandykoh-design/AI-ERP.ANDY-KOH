...
<head>
    ...
    <!-- Preload Helvetica Neue font to prevent FOUT -->
    <link rel="preload" href="{{ asset('fonts/HelveticaNeue.woff2') }}" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="{{ asset('fonts/HelveticaNeue-Medium.woff2') }}" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="{{ asset('fonts/HelveticaNeue-Bold.woff2') }}" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="{{ asset('vendor/webfonts/fa-solid-900.woff2') }}" as="font" type="font/woff2" crossorigin>
    <link rel="preload" href="{{ asset('vendor/fonts/Simple-Line-Icons.woff2') }}" as="font" type="font/woff2" crossorigin>
    ...
    <!-- Google Fonts for Prototype Design -->
    ...
    <style>
        ...
        body.dark-theme .bootstrap-select .dropdown-menu .dropdown-item {
            color: #cbd5e1 !important;
        }
        body.dark-theme .bootstrap-select .dropdown-menu .dropdown-item.active,
        body.dark-theme .bootstrap-select .dropdown-menu .dropdown-item:active {
            background-color: var(--header_color) !important;
            color: #ffffff !important;
        }
...
<script>
    ...
    const company = <?php echo json_encode(companyOrGlobalSetting()); ?>;
    const pusher_setting = <?php echo json_encode(pusher_settings()); ?>;
    const message_setting = <?php echo json_encode(message_setting()); ?>;

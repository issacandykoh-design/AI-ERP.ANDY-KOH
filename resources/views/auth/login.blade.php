...
<x-auth>
    <form id="login-form" action="{{ route('login') }}" class="ajax-form" method="POST">
        ...
        @if (!empty($socialAuthSettings) && $socialAuthSettings->google_status == 'enable')
        ...
        @endif
        @if (!empty($socialAuthSettings) && $socialAuthSettings->facebook_status == 'enable')
        ...
        @endif
        @if (!empty($socialAuthSettings) && $socialAuthSettings->twitter_status == 'enable')
        ...
        @endif
        @if (!empty($socialAuthSettings) && $socialAuthSettings->linkedin_status == 'enable')
        ...
        @if (!empty($socialAuthSettings) && $socialAuthSettings->social_auth_enable)
        ...
        <div class="form-group text-left">
            ...
            @endif
            @if ((data_get($socialAuthSettings, 'social_auth_enable_count', 0)) > 1)
        ...
        @if (((data_get($socialAuthSettings, 'social_auth_enable_count', 0)) > 1) && !$errors->has('g-recaptcha-response'))
        ...
        @if (iscravevaSaas() && !module_enabled('Subdomain'))
        ...
        <div id="password-section"
             @if (((data_get($socialAuthSettings, 'social_auth_enable_count', 0)) > 1) && !$errors->has('g-recaptcha-response')) class="d-none" @endif>
            <div class="form-group text-left">
    ...
    <x-slot name="scripts">
        ...
        <script>
            @if (iscraveva() && ($company?->attendance_status == 'active' && ($company?->attendance_setting?->radius_check == 'yes' || $company?->attendance_setting?->save_current_location == 'yes') ))

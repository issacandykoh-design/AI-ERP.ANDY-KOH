                ...
                <x-table class="table-bordered">
                    ...
                    @forelse($currencies as $key => $currency)
                        <tr class="row{{ $currency->id }}">
                            ...
                            <td><span data-toggle="tooltip" data-original-title="1 {{$currency->currency_code}} = {{$currency->exchange_rate}} {{companyOrGlobalSetting()->currency ? companyOrGlobalSetting()->currency->currency_code : 'USD'}}">

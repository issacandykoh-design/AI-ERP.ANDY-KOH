...
DROP TABLE IF EXISTS `affiliate_global_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `affiliate_global_settings` (
...
CREATE TABLE `affiliate_payouts` (
  ...
  `other_payment_method` varchar(191) DEFAULT NULL,
...
CREATE TABLE `affiliate_referrals` (
  ...
  `commissions` decimal(30,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `affiliate_settings` (
  `id` int(10) unsigned NOT NULL,
  `commission_enabled` varchar(191) NOT NULL DEFAULT 'yes',
  `payout_type` varchar(191) NOT NULL DEFAULT 'on signup',
  `payout_time` varchar(191) DEFAULT NULL,
  `commission_type` varchar(191) NOT NULL DEFAULT 'fixed',
  `commission_cap` int(10) unsigned NOT NULL DEFAULT 0,
  `minimum_payout` int(10) unsigned NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `assets` (
  ...
  `status` enum('lent','available','non-functional','lost','damaged','under-maintenance') NOT NULL DEFAULT 'available',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `automate_shifts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biolink_blocks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biolink_blocks` (
  `id` bigint(20) unsigned NOT NULL,
  `biolink_id` int(10) unsigned DEFAULT NULL,
  `type` varchar(191) NOT NULL,
  `name` varchar(191) DEFAULT NULL,
  `url` text DEFAULT NULL,
  `open_in_new_tab` tinyint(1) NOT NULL DEFAULT 0,
  `text_color` varchar(191) DEFAULT '#000000',
  `text_alignment` varchar(191) DEFAULT 'center',
  `background_color` varchar(191) DEFAULT '#FFFFFF',
  `animation` varchar(191) DEFAULT NULL,
  `heading_type` varchar(191) DEFAULT NULL,
  `paragraph` text DEFAULT NULL,
  `image` varchar(191) DEFAULT NULL,
  `image_alt` varchar(191) DEFAULT NULL,
  `avatar_size` varchar(191) DEFAULT NULL,
  `object_fit` varchar(191) NOT NULL DEFAULT 'cover',
  `border_radius` varchar(191) NOT NULL DEFAULT 'straight',
  `border_width` varchar(191) DEFAULT '0',
  `border_color` varchar(191) DEFAULT '#000000',
  `border_style` varchar(191) NOT NULL DEFAULT 'solid',
  `border_shadow_x` varchar(191) DEFAULT '0',
  `border_shadow_y` varchar(191) DEFAULT '0',
  `border_shadow_blur` varchar(191) DEFAULT '20',
  `border_shadow_spread` varchar(191) DEFAULT '0',
  `border_shadow_color` varchar(191) DEFAULT '#00000010',
  `status` varchar(191) NOT NULL DEFAULT 'active',
  `position` int(11) DEFAULT NULL,
  `icon_size` varchar(191) DEFAULT NULL,
  ...
  `reddit` varchar(191) DEFAULT NULL,
  ...
  `paypal_type` varchar(191) DEFAULT NULL,
  ...
  `name_placeholder` varchar(191) DEFAULT NULL,
  `button_text` varchar(191) DEFAULT NULL,
  `thank_you_message` varchar(191) DEFAULT NULL,
  `thank_you_url` varchar(191) DEFAULT NULL,
  `show_agreement` tinyint(1) DEFAULT 0,
  `agreement_text` varchar(191) DEFAULT NULL,
  `agreement_url` varchar(191) DEFAULT NULL,
  `api_key` varchar(191) DEFAULT NULL,
  `mailchimp_list` varchar(191) DEFAULT NULL,
  `webhook_url` varchar(191) DEFAULT NULL,
  `cancelled_payment_url` varchar(191) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biolink_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biolink_settings` (
  `id` int(10) unsigned NOT NULL,
  `biolink_id` int(10) unsigned DEFAULT NULL,
  `theme` varchar(191) NOT NULL DEFAULT 'Gradienta',
  `theme_color` varchar(191) DEFAULT NULL,
  `custom_color_one` varchar(191) DEFAULT NULL,
  `custom_color_two` varchar(191) DEFAULT NULL,
  `favicon` varchar(191) DEFAULT NULL,
  `font` varchar(191) NOT NULL DEFAULT 'arial',
  `block_space` varchar(191) NOT NULL DEFAULT 'medium',
  `block_hover_animation` varchar(191) NOT NULL DEFAULT 'none',
  `verified_badge` varchar(191) NOT NULL DEFAULT 'none',
  `display_branding` varchar(191) NOT NULL DEFAULT 'no',
  `branding_name` varchar(191) DEFAULT NULL,
  `branding_url` varchar(191) DEFAULT NULL,
  `branding_text_color` varchar(191) NOT NULL,
  `protection_password` varchar(191) NOT NULL,
  `is_sensitive` varchar(191) NOT NULL DEFAULT 'no',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biolinks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biolinks` (
  `id` int(10) unsigned NOT NULL,
  `company_id` int(10) unsigned DEFAULT NULL,
  `page_link` varchar(191) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biolinks_global_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biolinks_global_settings` (
  `id` bigint(20) unsigned NOT NULL,
  `purchase_code` varchar(191) DEFAULT NULL,
  `supported_until` timestamp NULL DEFAULT NULL,
  `purchased_on` timestamp NULL DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biometric_commands`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biometric_commands` (
  `id` bigint(20) unsigned NOT NULL,
  `company_id` int(10) unsigned NOT NULL,
  `device_serial_number` varchar(191) NOT NULL,
  `command_id` varchar(191) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biometric_device_attendances`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `biometric_devices` (
  ...
  `status` enum('pending','online','offline','unauthorized','communicated') NOT NULL DEFAULT 'pending',
  `last_online` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biometric_employees`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biometric_employees` (
  ...
  `biometric_employee_id` varchar(191) NOT NULL,
  `user_id` int(10) unsigned NOT NULL,
  ...
  `fingerprint_template` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `has_card` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biometric_global_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `biometric_global_settings` (
  `id` bigint(20) unsigned NOT NULL,
  `purchase_code` varchar(191) DEFAULT NULL,
  `supported_until` timestamp NULL DEFAULT NULL,
  `purchased_on` timestamp NULL DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `biometric_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `blacklist_emails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `check_ins` (
  ...
  `current_value` double(8,2) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cyber_securities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cyber_securities` (
  ...
  `email` varchar(191) DEFAULT NULL,
  `lockout_time` int(11) NOT NULL DEFAULT 2,
  `max_lockouts` int(11) NOT NULL DEFAULT 3,
  `extended_lockout_time` int(11) NOT NULL DEFAULT 1,
  `reset_retries` int(11) NOT NULL DEFAULT 24,
  `alert_after_lockouts` int(11) NOT NULL DEFAULT 2,
  `user_timeout` int(11) NOT NULL DEFAULT 10,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `cyber_security_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cyber_security_settings` (
  `id` bigint(20) unsigned NOT NULL,
  `purchase_code` varchar(191) DEFAULT NULL,
  `supported_until` timestamp NULL DEFAULT NULL,
  `purchased_on` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `deals` (
  ...
  `create_client` enum('0','1') NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `e_invoice_company_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `e_invoice_company_settings` (
  ...
  `e_invoice_company_id` varchar(191) DEFAULT NULL,
  `e_invoice_company_id_scheme` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `e_invoice_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `employee_document_expiries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `employee_document_expiries` (
  `id` bigint(20) unsigned NOT NULL,
  `company_id` int(10) unsigned DEFAULT NULL,
  `user_id` int(10) unsigned NOT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `employee_leave_quota_histories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `employee_monthly_salaries` (
  ...
  `effective_annual_salary` varchar(191) DEFAULT NULL,
  `effective_monthly_salary` varchar(191) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `employee_shift_rotations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `file_storage` (
  ...
  `storage_location` enum('local','aws_s3') NOT NULL DEFAULT 'local',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `global_invoice_settings` (
  ...
  `billing_tax_name` varchar(191) DEFAULT NULL,
  `billing_tax_id` varchar(191) DEFAULT NULL,
  `logo` varchar(191) DEFAULT NULL,
...
CREATE TABLE `global_settings` (
  ...
  `sign_up_phone_field` enum('yes','no') NOT NULL DEFAULT 'no',
  `sign_up_phone_required` enum('yes','no') NOT NULL DEFAULT 'no',
...
CREATE TABLE `goal_types` (
  `id` bigint(20) unsigned NOT NULL,
  `company_id` int(10) unsigned DEFAULT NULL,
  `type` enum('individual','department','company') NOT NULL DEFAULT 'individual',
  ...
  `view_by_roles` text DEFAULT NULL,
  `manage_by_roles` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `invoices` (
  ...
  `estimate_id` int(10) unsigned DEFAULT NULL,
  `send_status` tinyint(1) NOT NULL DEFAULT 1,
  `due_amount` double(30,2) NOT NULL DEFAULT 0.00,
  ...
  CONSTRAINT `invoices_invoice_recurring_id_foreign` FOREIGN KEY (`invoice_recurring_id`) REFERENCES `invoice_recurring` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `key_results` (
  ...
  `title` varchar(191) NOT NULL,
  `description` text DEFAULT NULL,
  `metrics_id` int(10) unsigned DEFAULT NULL,
  `target_value` decimal(16,2) DEFAULT NULL,
  `current_value` decimal(16,2) DEFAULT NULL,
  `original_current_value` double(8,2) DEFAULT NULL,
  `key_percentage` double(8,2) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `key_results_metrics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `key_results_metrics` (
  `id` bigint(20) unsigned NOT NULL,
  `company_id` int(10) unsigned DEFAULT NULL,
  `name` varchar(191) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `product_attributes` (
  ...
  `attribute_type` enum('text','number','select','boolean') NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product_attributes_attribute_name_unique` (`attribute_name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_bundle_items` (
  ...
  `substitute_product_id` int(10) unsigned DEFAULT NULL,
  `display_order` int(11) DEFAULT NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `product_bundle_option_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_bundle_option_items` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_bundle_option_items_option_id_product_id_index` (`option_id`,`product_id`),
  CONSTRAINT `product_bundle_option_items_option_id_foreign` FOREIGN KEY (`option_id`) REFERENCES `product_bundle_options` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_bundle_options` (
  ...
  `option_type` enum('single_choice','multiple_choice') NOT NULL,
  `min_selections` int(11) DEFAULT NULL,
  `max_selections` int(11) DEFAULT NULL,
  `display_order` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_bundle_options_bundle_id_index` (`bundle_id`),
  CONSTRAINT `product_bundle_options_bundle_id_foreign` FOREIGN KEY (`bundle_id`) REFERENCES `product_bundles` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_bundles` (
  ...
  `bundle_type` enum('fixed','customizable','optional') NOT NULL,
  `bundle_name` varchar(191) NOT NULL,
  `bundle_description` text DEFAULT NULL,
  `bundle_price` decimal(12,2) DEFAULT NULL,
  `bundle_discount_type` enum('percentage','fixed_amount','override_price') DEFAULT NULL,
  `bundle_discount_value` decimal(12,2) DEFAULT NULL,
  `min_items_required` int(11) DEFAULT NULL,
  `max_items_allowed` int(11) DEFAULT NULL,
...
CREATE TABLE `product_variants` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `product_variants_variant_sku_unique` (`variant_sku`),
...
CREATE TABLE `product_variation_options` (
  ...
  `price_adjustment` decimal(12,2) NOT NULL DEFAULT 0.00,
  `sku_suffix` varchar(191) DEFAULT NULL,
  `stock_quantity` int(11) DEFAULT NULL,
  `is_default` tinyint(1) NOT NULL DEFAULT 0,
  `display_order` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `product_variation_options_variation_id_index` (`variation_id`),
  CONSTRAINT `product_variation_options_variation_id_foreign` FOREIGN KEY (`variation_id`) REFERENCES `product_variations` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_variations` (
  ...
  `variation_type` enum('single','multiple') NOT NULL,
  `is_required` tinyint(1) NOT NULL DEFAULT 0,
  `display_order` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `user_taskboard_settings` (
  ...
  CONSTRAINT `user_taskboard_settings_board_column_id_foreign` FOREIGN KEY (`board_column_id`) REFERENCES `taskboard_columns` (`id`) ON UPDATE CASCADE,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (4,'2016_06_20_112951_create_user_chat_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (5,'2017_03_23_110416_add_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2017_03_23_111036_create_client_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (7,'2017_03_23_112028_create_client_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (8,'2017_03_23_112353_create_employee_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (9,'2017_03_23_114438_create_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (10,'2017_03_23_122646_create_project_category_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (11,'2017_03_23_123601_create_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (12,'2017_03_23_125424_create_project_members_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (13,'2017_03_23_125625_create_project_time_logs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2017_03_23_130413_create_project_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2017_03_24_051800_create_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (16,'2017_03_24_054355_create_notices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (17,'2017_03_24_055005_create_conversation_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2017_03_24_055539_create_conversation_reply_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (19,'2017_03_24_055859_create_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (20,'2017_03_24_060421_create_invoice_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (21,'2017_03_24_060751_create_quotations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (22,'2017_03_24_061241_create_quotation_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (23,'2017_03_24_061505_create_sticky_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (24,'2017_03_24_064541_create_issues_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (25,'2017_03_29_123858_entrust_setup_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (26,'2017_04_04_193158_AddColumnsProjectFilesTable',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (27,'2017_04_05_063103_change_clientid_projectid_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (28,'2017_04_06_051401_add_discount_column_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (29,'2017_04_06_054728_add_status_column_issues_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2017_04_08_152902_add_total_hours_column_time_log_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2017_04_18_095809_create_project_activity_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2017_04_18_103815_create_user_activities_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (33,'2017_04_19_101519_create_email_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (34,'2017_04_20_185211_add_colour_column_sticky_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (35,'2017_04_28_114154_create_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (36,'2017_05_03_131016_add_project_completion_field_projects',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (37,'2017_05_03_174333_create_currencies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (38,'2017_05_05_124330_create_module_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (39,'2017_05_05_233111_add_status_column_invoices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (40,'2017_05_11_140502_add_currency_symbol_column_invoices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (41,'2017_05_11_170244_add_currency_id_column_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (42,'2017_05_22_172748_add_timezone_column_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (43,'2017_05_24_120216_create_smtp_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (44,'2017_05_31_112158_create_universal_search_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (45,'2017_06_22_131112_add_locale_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (46,'2017_07_13_091922_add_calculate_task_progress_column_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (47,'2017_07_20_093528_on_delete_setnull_timelog',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (48,'2017_07_21_120958_create_theme_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (49,'2017_07_24_113657_add_link_color_column_theme_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (50,'2017_07_24_123050_add_login_background_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (51,'2017_07_27_101351_add_column_type_invoice_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (52,'2017_07_28_102010_create_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (53,'2017_07_28_103230_create_estimate_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (54,'2017_08_04_064431_create_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (55,'2017_08_05_103940_create_payment_gateway_credential_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (56,'2017_08_08_055908_add_enable_paypal_column_payment_gateway_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (57,'2017_08_09_054230_create_expenses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (58,'2017_08_21_065430_add_exchange_rate_column_currency_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (59,'2017_08_21_131318_create_invoice_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (60,'2017_08_22_055908_add_expense_email_setting_to_email_notification_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (61,'2017_08_28_110759_add_recurring_columns_in_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (62,'2017_08_30_061016_add_plan_id_to_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (63,'2017_08_30_093400_create_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (64,'2017_08_30_123956_add_slack_username_column_employee_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (65,'2017_08_30_133725_add_send_slack_column_email_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (66,'2017_09_01_060715_add_stipe_column_to_payment_credentials_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (67,'2017_09_01_090124_add_customer_id_column_to_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (68,'2017_09_02_084049_add_locale_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (69,'2017_09_14_095429_create_ticket_reply_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (70,'2017_09_14_095815_create_ticket_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (71,'2017_09_14_100400_create_ticket_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (72,'2017_09_14_100530_create_ticket_tag_list_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (73,'2017_09_14_114900_create_ticket_channels_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (74,'2017_09_14_115003_create_ticket_agent_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (75,'2017_09_14_115004_create_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (76,'2017_09_14_115005_create_ticket_tags_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (77,'2017_09_18_064917_add_status_column_ticket_agent_group_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (78,'2017_09_24_101700_create_ticket_replies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (79,'2017_09_25_060229_drop_description_column_ticket_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (80,'2017_09_25_072611_add_deleted_at_column_tickets',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (81,'2017_09_25_072627_add_deleted_at_column_ticket_reply',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (82,'2017_10_03_094922_ticket_notification_migration',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (83,'2017_10_03_134003_add_latitude_longitude_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (84,'2017_10_12_111741_create_attendance_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (85,'2017_10_13_051909_create_attendance_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (86,'2017_10_26_051335_add_mail_from_email_column_smtp_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (87,'2017_10_26_112253_add_office_open_days_column_attendance_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (88,'2017_11_01_054603_add_columns_to_client_details',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (89,'2017_11_02_045542_change_on_cascade_project_members',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (90,'2017_11_07_054438_add_project_admin_column_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (91,'2017_11_07_125619_remove_project_admin_role',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (92,'2017_11_08_045549_make_project_id_nullable_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (93,'2017_11_09_071318_create_taskboard_columns_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (94,'2017_11_09_092817_add_column_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (95,'2017_11_20_070830_create_custom_fields_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (96,'2017_11_20_071758_create_custom_fields__data_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (97,'2017_11_22_071535_create_events_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (98,'2017_11_23_065323_add_cryptocurrency_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (99,'2017_11_24_103957_create_event_attendees_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (100,'2017_12_07_034433_change cascade users in time log table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (101,'2017_12_12_071823_create_modules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (102,'2017_12_12_073501_add_module_id_column_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (103,'2017_12_21_114839_change_upload_folder',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (104,'2017_12_28_112910_create_leave_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (105,'2017_12_30_184422_create_leaves_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (106,'2018_01_02_122442_add_leaves_notification_setting',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (107,'2018_01_05_062543_add_user_css_column_theme_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (108,'2018_01_09_180937_add_task_completed_notification_setting',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (109,'2018_01_29_073527_create_message_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (110,'2018_04_12_100452_add_dropbox_link_column_project_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (111,'2018_04_12_123243_create_file_storage_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (112,'2018_04_13_072732_create_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (113,'2018_04_13_092757_create_employee_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (114,'2018_04_17_113657_set_attendance_late_column_default',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (115,'2018_05_07_065407_alter_invoice_id_null_payments',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (116,'2018_05_07_065557_add_currency_id_column_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (117,'2018_05_08_064539_add_note_column_invoices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (118,'2018_05_15_072536_add_project_id_column_payments',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (119,'2018_05_28_094515_set_gateway_column_null_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (120,'2018_05_29_070343_change_completed_on_column_to_datetime',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (121,'2018_05_29_114402_populate_file_storage_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (122,'2018_05_30_051128_add_google_url_to_project_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (123,'2018_06_05_092136_create_sub_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (124,'2018_06_06_091511_create_task_comments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (125,'2018_06_11_054204_create_push_subscriptions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (126,'2018_06_14_094059_create_taxes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (127,'2018_06_18_065034_add_tax_id_column_invoice_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (128,'2018_06_18_071442_add_discount_column_invoice_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (129,'2018_06_21_052408_change_default_taskboard_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (130,'2018_06_26_160023_add_leave_count_column_leave_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (131,'2018_06_27_072813_add_leaves_start_from_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (132,'2018_06_27_075233_add_joining_date_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (133,'2018_06_27_113713_add_gender_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (134,'2018_06_28_054604_add_client_view_task_column_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (135,'2018_06_28_191256_create_language_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (136,'2018_06_29_060331_add_active_theme_column_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (137,'2018_06_29_081128_add_manual_timelog_column_project_timelog',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (138,'2018_06_29_104709_seed_languages',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (139,'2018_08_02_121259_add_minutes_column_time_log_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (140,'2018_08_22_103829_add_leaves_module',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (141,'2018_08_22_104302_add_leaves_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (142,'2018_08_27_114329_add_module_list_in_module_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (143,'2018_08_30_065158_add_status_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (144,'2018_08_31_095814_create_lead_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (145,'2018_08_31_095815_create_lead_source_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (146,'2018_08_31_095815_create_lead_status_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (147,'2018_08_31_095816_create_lead_follow_up_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (148,'2018_09_04_095158_alter_lead_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (149,'2018_09_04_095816_add_lead_module',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (150,'2018_09_05_102010_create_proposal_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (151,'2018_09_05_113230_create_proposal_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (152,'2018_09_07_051239_alter_lead_website_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (153,'2018_09_15_174026_add_default_lead_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (154,'2018_09_17_045718_add_leads_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (155,'2018_09_19_091643_add_remarks_to_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (156,'2018_09_19_100708_create_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (157,'2018_09_21_095816_create_offline_payment_method_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (158,'2018_09_25_065158_alter_payment_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (159,'2018_09_28_110029_create_log_time_for_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (160,'2018_09_28_965158_alter_project_time_log_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (161,'2018_10_08_091643_alter_project_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (162,'2018_10_08_110029_create_lead_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (163,'2018_10_10_110029_create_holidays_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (164,'2018_10_10_123601_create_project_templates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (165,'2018_10_10_125424_create_project_template_members_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (166,'2018_10_10_135816_add_holiday_module',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (167,'2018_10_10_251800_create_project_template_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (168,'2018_10_16_095816_add_holiday_module_detail',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (169,'2018_10_17_081757_remove_config_datatable_file',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (170,'2018_10_17_965158_alter_leads_address_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (171,'2018_10_17_965168_alter_leads_phone_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (172,'2018_10_18_091643_alter_attendance_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (173,'2018_10_19_045718_add_holidays_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (174,'2018_10_20_094413_add_products_module',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (175,'2018_10_20_094504_add_products_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (176,'2018_10_21_051239_alter_holiday_website_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (177,'2018_10_24_071300_add_file_column_to_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (178,'2018_10_24_965158_alter_employee_detail_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (179,'2018_10_29_965158_alter_attendance_setting_default_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (180,'2018_11_10_071300_alter_user_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (181,'2018_11_10_122646_create_task_category_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (182,'2018_11_30_965158_alter_invoice_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (183,'2018_12_12_965158_alter_invoice_estimate_response_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (184,'2018_12_14_094504_add_expenses_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (185,'2018_12_14_194504_add_expenses_permissions_detail',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (186,'2018_12_20_1065158_alter_company_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (187,'2018_12_20_965158_alter_estimate_quantity_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (188,'2018_12_27_074504_check_verify_purchase_file',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (189,'2018_12_28_075730_create_push_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (190,'2018_12_28_082056_add_send_push_column_email_notification_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (191,'2018_12_28_123245_add_onesignal_player_id_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (192,'2019_01_02_1065158_alter_module_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (193,'2019_01_02_2065158_insert_module_setting_client_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (194,'2019_01_04_110029_create_employee_docs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (195,'2019_01_21_1065158_alter_task_creator_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (196,'2019_02_06_1065158_alter_attendance_check_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (197,'2019_02_11_1065158_alter_log_time_for_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (198,'2019_02_12_2065158_insert_module_setting_client_task_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (199,'2019_02_13_110029_create_skills_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (200,'2019_02_13_130029_create_employee_skills_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (201,'2019_02_15_1065158_alter_employee_end_date_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (202,'2019_02_15_1165158_alter_custom_status_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (203,'2019_02_20_074848_create_jobs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (204,'2019_02_22_1165158_add_company_currency_api_google_api',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (205,'2019_03_11_965158_alter_expenses_quantity_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (206,'2019_04_03_965158_alter_project_deadline_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (207,'2019_04_04_074848_alter_invoice_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (208,'2019_04_04_075848_alter_client_Details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (209,'2019_04_10_075848_alter_setting_task_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (210,'2019_04_10_122921_add_weather_key_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (211,'2019_04_12_100242_add_columns_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (212,'2019_04_15_115700_add_budget_columns_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (213,'2019_04_17_070105_create_project_milestones_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (214,'2019_04_23_062017_add_item_summary_column_invoice_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (215,'2019_04_23_083812_add_invoice_created_column_project_milestones_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (216,'2019_04_23_101747_add_milestone_id_column_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (217,'2019_06_04_180628_change_project_budget_field_type',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (218,'2019_06_07_070913_add_tax_id_column_estimate_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (219,'2019_06_07_080053_add_discount_column_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (220,'2019_07_01_192543_change_size_price_in_double',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (221,'2019_07_02_072314_add_description_column_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (222,'2019_07_15_110127_add_project_id_column_in_expenses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (223,'2019_08_13_073129_update_settings_add_craveva_key',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (224,'2019_08_13_073129_update_settings_add_support_key',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (225,'2019_08_16_080219_change_price_size_proposal',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (226,'2019_08_17_072443_add_datepicker_format_column_in_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (227,'2019_08_19_000000_create_failed_jobs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (228,'2019_08_19_085009_add_google_recaptcha_columns_in_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (229,'2019_08_19_120826_add_app_debug_column_in_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (230,'2019_08_22_055908_add_invoice_email_setting_to_email_notification_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (231,'2019_08_22_121805_add_external_link_column_project_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (232,'2019_08_26_120718_add_offline_method_id_column_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (233,'2019_08_28_081847_update_smtp_setting_verified',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (234,'2019_08_29_140115_make_smtp_type_nullable',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (235,'2019_08_30_102114_add_reminder_fields_in_events_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (236,'2019_09_03_103533_add_razorpay_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (237,'2019_09_04_115714_add_recurring_task_id_column_in_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (238,'2019_09_05_061308_create_project_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (239,'2019_09_09_045256_add_estimate_number_column_in_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (240,'2019_09_09_081030_add_rounded_theme_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (241,'2019_09_09_115714_add_cron_job_message_hide_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (242,'2019_09_10_1074848_create_designation_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (243,'2019_09_10_111909_add_columns_in_invoice_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (244,'2019_09_10_115714_add_team_field_employee_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (245,'2019_09_10_161408_create_credit_note_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (246,'2019_09_10_161418_create_credit_note_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (247,'2019_09_10_161428_add_credit_note_column_in_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (248,'2019_09_14_074854_add_status_column_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (249,'2019_09_16_101138_create_gdpr_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (250,'2019_09_17_091214_create_removal_requests_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (251,'2019_09_18_191957_add_payments_module_clients',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (252,'2019_09_25_095015_create_removal_requests_lead_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (253,'2019_09_25_183130_create_dashboard_widgets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (254,'2019_09_27_212735_add_timelog_module_clients',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (255,'2019_10_04_101818_add_paypal_mode_in_payment_gateway_credentials_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (256,'2019_10_10_115133_alter_status_column_in_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (257,'2019_10_14_060314_create_accept_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (258,'2019_10_14_090840_alter_project_id_column_in_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (259,'2019_10_14_110606_add_estimate_id_column_in_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (260,'2019_10_15_052931_create_contract_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (261,'2019_10_15_052932_create_contracts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (262,'2019_10_15_084310_add_contract_module_in_module_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (263,'2019_10_15_115655_create_contract_signs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (264,'2019_10_15_120940_create_invoice_credit_note_pivot_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (265,'2019_10_17_051544_create_contract_discussions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (266,'2019_10_18_045028_alter_credit_note_status_in_credit_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (267,'2019_10_21_130413_create_task_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (268,'2019_10_21_230413_create_ticket_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (269,'2019_10_22_063419_add_dependent_task_id_in_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (270,'2019_10_23_122412_create_contract_renews_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (271,'2019_10_24_045038_add_column_module_type_in_universal_search_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (272,'2019_10_24_120220_add_origin_amount_column_in_contracts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (273,'2019_10_30_045045_add_column_invoice_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (274,'2019_10_30_122412_create_lead_agent_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (275,'2019_10_31_045055_add_column_credit_note_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (276,'2019_10_31_045065_add_column_estimate_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (277,'2019_11_01_045075_add_column_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (278,'2019_11_01_142619_add_column_to_in_notices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (279,'2019_11_05_082637_add_client_id_in_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (280,'2019_11_07_082637_add_purchase_allow_in_product_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (281,'2019_11_12_054145_add_system_update_column_in_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (282,'2019_11_13_054155_add_employee_id_column_in_employee_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (283,'2019_11_14_054145_add_discount_column_in_proposal_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (284,'2019_11_14_064145_add_tax_column_in_proposal_item_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (285,'2019_11_21_064155_add_task_module_in_module_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (286,'2019_12_01_115133_alter_invoice_status_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (287,'2019_12_09_171149_make_taxes_nullable_propsal_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (288,'2019_12_18_115133_alter_proposal_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (289,'2019_12_19_115850_add_timelogs_client_modules',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (290,'2019_12_20_143625_add_logo_background_color_column_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (291,'2020_01_09_100241_add_client_id_credit_note_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (292,'2020_01_09_105514_set_default_status_credit_note_open',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (293,'2020_01_09_121406_add_task_reminder_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (294,'2020_01_22_122009_add_is_private_column_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (295,'2020_01_23_062328_create_task_history_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (296,'2020_01_24_134008_add_default_task_status_column_organisation_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (297,'2020_01_27_122145_create_pusher_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (298,'2020_02_01_101914_update_settings_review',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (299,'2020_02_04_061753_add_team_id_field_in_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (300,'2020_02_04_132100_add_contracts_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (301,'2020_02_10_093726_create_table_menu',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (302,'2020_02_14_102832_create_task_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (303,'2020_02_17_143257_add_slug_email_notification_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (304,'2020_02_21_121956_update_storage_settings_to_local',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (305,'2020_02_24_060416_update_invoice_setting_logo',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (306,'2020_03_11_054833_add_shipping_address_field_in_client_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (307,'2020_03_11_085729_add_show_shipping_field_in_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (308,'2020_03_17_411909_alter_invocie_number_in_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (309,'2020_03_19_112832_create_project_template_task_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (310,'2020_03_20_2065158_insert_modules_setting_client_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (311,'2020_03_23_185549_make_message_nullable_ticket_reply_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (312,'2020_04_06_130331_create_discussion_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (313,'2020_04_06_132027_create_discussions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (314,'2020_04_06_133759_create_discussion_replies_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (315,'2020_04_08_094325_add_best_answer_id_discussions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (316,'2020_04_08_125803_add_discussion_reply_email_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (317,'2020_04_09_102411_add_last_reply_by_discussions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (318,'2020_04_12_2065158_insert_contract_employee_modules_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (319,'2020_04_14_144941_add_last_login_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (320,'2020_04_20_083724_add_hourly_rate_project_timelogs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (321,'2020_04_20_114349_add_hourly_rate_project_members',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (322,'2020_04_20_173833_add_project_id_value_for_tasks_timelogs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (323,'2020_04_23_124301_add_billable_column_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (324,'2020_04_24_115049_add_approved_invoice_id_column_project_time_logs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (325,'2020_04_24_122510_add_approval_required_column_log_time_for',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (326,'2020_05_13_070505_change_earning_by_minutes_timelogs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (327,'2020_05_13_113533_add_receipt_column_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (328,'2020_05_19_114539_add_custom_field_groups',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (329,'2020_05_20_131017_change_project_team_id_cascade',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (330,'2020_05_21_041143_create_social_auth_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (331,'2020_05_26_084027_add_column_expenses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (332,'2020_05_30_093624_add_send_status_column_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (333,'2020_06_01_080620_add_send_status_column_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (334,'2020_06_02_160923_add_email_notifications_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (335,'2020_06_15_100530_create_task_tag_list_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (336,'2020_06_15_116005_create_task_tags_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (337,'2020_06_16_160933_alter_date_format_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (338,'2020_06_20_030225_alter_task_tags_to_label_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (339,'2020_06_26_131840_add_column_priority_column_leads_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (340,'2020_06_29_141051_create_sessions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (341,'2020_07_06_171614_add_phone_country_code_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (342,'2020_07_07_2065158_insert_module_setting_client_expense_payment_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (343,'2020_07_08_2065258_enter_lead_status_id_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (344,'2020_07_08_2931840_add_column_category_id_in_template_task_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (345,'2020_07_15_112558_add_default_currency_projects',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (346,'2020_07_16_583130_alter_dashboard_widgets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (347,'2020_07_21_583130_add_due_amount_column_in_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (348,'2020_08_13_114705_set_task_category_id_column_null',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (349,'2020_08_19_051839_create_employee_leave_quotas_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (350,'2020_08_25_081839_add_columns_in_notices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (351,'2020_08_25_081839_alter_leads_value_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (352,'2020_08_28_081839_add_columns_parent_in_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (353,'2020_09_17_114705_set_credit_note_amount',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (354,'2020_09_17_196005_create_task_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (355,'2020_09_18_104145_add_estimate_fields_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (356,'2020_09_24_522646_create_expenses_category_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (357,'2020_09_28_054230_create_expenses_recurring_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (358,'2020_10_06_522646_create_product_category_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (359,'2020_10_07_522646_create_pinned_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (360,'2020_10_15_054230_create_invoice_recurring_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (361,'2020_10_20_094043_add_dashboard_clock_column_organisation_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (362,'2020_10_29_111515_add_companylogo_address_column_in_contracts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (363,'2020_11_02_130413_create_contract_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (364,'2020_11_17_115634_add_lead_custom_field_group',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (365,'2020_11_18_065533_create_lead_custom_forms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (366,'2020_11_18_083624_add_city_state_to_client_details',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (367,'2020_11_18_090244_add_city_state_to_leads_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (368,'2020_11_19_063807_add_city_state_column_in_contracts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (369,'2020_11_19_091349_alter_country_cell_column_in_client_details',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (370,'2020_11_20_104942_create_lead_category_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (371,'2020_11_23_052427_add_category_id_column_in_leads_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (372,'2020_11_25_114705_cancel_status_estimate',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (373,'2020_11_27_092136_create_project_template_sub_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (374,'2020_12_01_092136_create_notice_view_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (375,'2020_12_02_055908_add_product_purchase_email_notification_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (376,'2020_12_03_065533_create_ticket_custom_forms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (377,'2020_12_04_114305_create_client_category_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (378,'2020_12_08_075308_create_project_rating_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (379,'2020_12_08_082101_add_paid_column_in_leave_types',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (380,'2020_12_08_110140_add_paid_column_in_leaves_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (381,'2020_12_21_072055_create_permission_types_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (382,'2020_12_21_072058_create_user_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (383,'2020_12_21_132255_add_user_permisisons',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (384,'2020_12_22_071337_add_owned_by_added_by_last_updated_by_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (385,'2020_12_28_200000_add_two_factor_columns_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (386,'2020_12_30_101513_add_owned_by_added_by_last_updated_by_columns_projects',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (387,'2021_01_11_110041_add_owned_by_added_by_last_updated_by_columns_tasks',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (388,'2021_01_18_084827_add_estimate_terms_column_invoice_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (389,'2021_01_19_060745_add_slug_new_product_purchase_in_email_notification_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (390,'2021_01_29_152503_lead_custom_field_name_change',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (391,'2021_02_05_055908_add_lead_proposal_email_setting',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (392,'2021_02_05_114041_create_user_taskboard_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (393,'2021_02_08_115655_create_proposal_signs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (394,'2021_02_15_085425_modify_status_column_in_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (395,'2021_02_15_135533_alter_lead_custom_forms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (396,'2021_02_16_082106_add_mobile_column_in_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (397,'2021_02_16_100313_add_added_by_last_updated_by_columns_to_events_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (398,'2021_02_16_102604_add_added_by_last_updated_by_columns_to_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (399,'2021_02_16_102906_add_added_by_last_updated_by_columns_to_notices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (400,'2021_02_17_122943_change_client_details_foreign_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (401,'2021_02_19_102125_add_salutation_column_to_leads_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (402,'2021_02_20_185545_add_owned_by_added_by_last_updated_by_columns_invoices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (403,'2021_02_22_101316_add_owned_by_added_by_last_updated_by_columns_payments',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (404,'2021_02_23_173243_add_column_length_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (405,'2021_02_24_084749_add_owned_by_added_by_last_updated_by_columns_estimates',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (406,'2021_02_25_052941_add_owned_by_added_by_last_updated_by_columns_leads',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (407,'2021_02_26_092320_create_currency_format_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (408,'2021_02_26_092817_add_sac_code_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (409,'2021_02_27_070155_add_added_by_last_updated_by_columns_to_leaves_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (410,'2021_02_28_095653_add_owned_by_added_by_last_updated_by_columns_expenses',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (411,'2021_03_01_133056_create_user_leadboard_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (412,'2021_03_03_071758_add_owned_by_added_by_last_updated_by_columns_tinelogs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (413,'2021_03_03_130641_add_moment_format_column_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (414,'2021_03_04_060745_add_new_for_null_slug_email_notification_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (415,'2021_03_08_022302_add_added_by_last_updated_by_columns_to_holidays_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (416,'2021_03_09_123344_add_owned_by_added_by_last_updated_by_columns_contracts',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (417,'2021_03_11_070400_update_contract_type_cascade',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (418,'2021_03_15_112622_add_owned_by_added_by_last_updated_by_columns_attendance',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (419,'2021_03_15_145533_add_last_cron_run_in_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (420,'2021_03_19_091501_add_favicon_in_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (421,'2021_03_19_123557_add_owned_by_added_by_last_updated_by_columns_tickets',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (422,'2021_04_06_111105_sync_default_role_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (423,'2021_04_08_021853_add_owned_by_added_by_last_updated_by_columns_invoice_recurring',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (424,'2021_04_14_080502_add_decription_column_in_proposals_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (425,'2021_05_01_220324_add_dashboard_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (426,'2021_05_03_055859_add_owned_by_added_by_last_updated_by_columns_credit_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (427,'2021_05_17_133302_reset_theme_default_colors',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (428,'2021_05_26_102905_craete_client_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (429,'2021_05_30_174638_craete_project_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (430,'2021_05_31_050747_add_send_reminder_in_invoice_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (431,'2021_05_31_102117_task_share_unique_hash',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (432,'2021_06_03_104606_add_owned_by_added_by_last_updated_by_columns_project_ratings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (433,'2021_06_07_132858_create_user_invitations_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (434,'2021_06_08_072201_add_close_date_in_ticket_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (435,'2021_06_09_101110_remove_visible_rating_employee_column_from_projects_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (436,'2021_06_16_185748_add_dark_theme_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (437,'2021_06_24_185748_add_column_payment_gateway_credentials_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (438,'2021_06_29_104606_add_manage_project_template_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (439,'2021_07_07_093528_alter_userid_on_project_template_member',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (440,'2021_07_20_102117_invoice_client_fix',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (441,'2021_07_23_181545_add_status_column_to_slack_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (442,'2021_07_25_041851_add_report_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (443,'2021_08_04_171200_add_mail_connection_column_email_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (444,'2021_08_06_085318_remove_on_delete_cascade_from_category_id_on_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (445,'2021_08_10_081641_change_default_value_of_paypal_and_stripe_on_payment_gateway_credentials_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (446,'2021_08_10_092728_add_allowed_permission_column_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (447,'2021_08_10_092728_alter_allowed_permission_column_permissions_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (448,'2021_08_13_094921_change_notification_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (449,'2021_08_16_161256_set_discussion_category_id_null_on_category_delete',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (450,'2021_08_17_095756_change_details_columns_type_to_longtext_on_client_note_and_project_note_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (451,'2021_08_19_174641_change_text_longtext',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (452,'2021_08_20_100009_change_hourly_rate_double',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (453,'2021_08_20_121027_add_dashboard_module_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (454,'2021_08_23_125630_create_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (455,'2021_08_26_120755_add_order_id_column_to_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (456,'2021_08_27_100840_add_order_id_to_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (457,'2021_08_31_071303_add_failed_status_on_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (458,'2021_09_01_124609_add_order_module_and_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (459,'2021_09_02_080343_add_hash_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (460,'2021_09_02_182736_add_notice_module_clients',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (461,'2021_09_03_182020_add_default_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (462,'2021_09_06_182020_change_dashboard_widget_name',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (463,'2021_09_07_084452_delete_notices_module_from_client',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (464,'2021_09_08_142150_add_payment_gateway_response_column_to_payment_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (465,'2021_09_09_085024_add_taskboard_message_pusher_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (466,'2021_09_14_162221_add_payload_id_to_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (467,'2021_09_15_072728_copy_credit_notes_invoice_table_data_to_payments_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (468,'2021_09_15_190915_add_column_calculate_tax',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (469,'2021_09_17_115037_remove_credit_notes_invoice_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (470,'2021_09_20_095509_alter_and_add_payment_gateways_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (471,'2021_09_22_045939_change_subtask_in_notifications_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (472,'2021_09_22_085009_change_google_recaptcha_columns_in_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (473,'2021_09_24_083220_add_currency_id_to_contracts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (474,'2021_09_24_100722_add_view_hourly_rate_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (475,'2021_09_29_071418_add_salutation_column_on_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (476,'2021_09_29_075245_add_lead_status_change_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (477,'2021_09_30_130413_attendance_setting_alert',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (478,'2021_10_01_074809_add_leave_change_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (479,'2021_10_03_190531_add_sidebar_logo_style_column_global_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (480,'2021_10_04_045942_add_2fa_columns_on_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (481,'2021_10_04_130413_create_expenses_category_roles_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (482,'2021_10_05_064140_change_date_null_in_task_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (483,'2021_10_05_130413_custom_field_group_change_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (484,'2021_10_06_130413_create_sub_task_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (485,'2021_10_11_092617_add_session_driver_column_organisation_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (486,'2021_10_12_062814_change_authenticate_via_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (487,'2021_10_12_073058_make_email_nullable_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (488,'2021_10_12_121613_add_approve_reject_leaves_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (489,'2021_10_13_103621_add_client_signup_columns_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (490,'2021_10_14_073904_add_admin_approval_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (491,'2021_10_16_113306_add_two_factor_confirmed_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (492,'2021_10_18_131815_allow_gender_null',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (493,'2021_10_21_104332_add_employee_owned_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (494,'2021_10_26_175349_change_ticket_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (495,'2021_10_28_120427_add_recurring_columns_tasks',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (496,'2021_11_11_145726_add_allowed_file_types_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (497,'2021_11_13_063519_add_paystack_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (498,'2021_11_16_105840_change_product_sub_cat_relation',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (499,'2021_11_17_111317_add_mollie_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (500,'2021_11_17_173210_create_company_addresses_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (501,'2021_11_18_053337_add_tax_calculation_msg_to_invoice_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (502,'2021_11_19_115843_add_project_type_column_projects',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (503,'2021_11_22_114532_move_gst_to_compane_address',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (504,'2021_11_24_093356_add_payfast_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (505,'2021_11_24_093619_create_invoice_item_images_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (506,'2021_11_25_134531_fix_timelog_time',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (507,'2021_11_26_063416_add_authorize_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (508,'2021_11_29_060348_create_discussion_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (509,'2021_11_30_063441_add_square_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (510,'2021_12_08_100451_add_image_column_to_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (511,'2021_12_10_112406_add_permission_sync_column_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (512,'2021_12_13_070928_add_proposal_items_images_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (513,'2021_12_14_112039_add_location_column_company_addresses',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (514,'2021_12_15_090905_create_recurring_invoice_item_images_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (515,'2021_12_15_112911_add_recurring_expense_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (516,'2021_12_17_041814_create_job_batches_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (517,'2021_12_20_053945_add_order_item_image_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (518,'2021_12_21_044934_add_google_event_id_to_several_tables',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (519,'2021_12_21_064709_add_title_field_in_client_contact_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (520,'2021_12_21_121710_create_google_calendar_modules_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (521,'2021_12_23_102347_change_clock_out_ip_make_nullable_to_attendances_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (522,'2021_12_24_045226_add_paystack_mode_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (523,'2021_12_24_085109_add_save_location_column_attendance_settings',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (524,'2021_12_27_065645_create_knowledgebase_categories_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (525,'2021_12_27_090829_create_knowledge_bases_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (526,'2021_12_28_112808_add_module_knowledgebase_and_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (527,'2021_12_29_124232_add_lead_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (528,'2021_12_30_082542_add_added_by_column_knowledge_base_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (529,'2022_01_03_090136_add_downloadable_to_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (530,'2022_01_03_103014_create_database_backup_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (531,'2022_01_03_125020_add_product_id_to_order_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (532,'2022_01_06_053854_set_product_description_to_nullable_in_products_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (533,'2022_01_06_093627_add_default_permission_to_knowledge_bases_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (534,'2022_01_11_104355_create_translate_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (535,'2022_01_13_080729_add_flutterwave_to_payment_gateway_credentials',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (536,'2022_01_14_122713_add_change_role_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (537,'2022_01_15_055907_create_product_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (538,'2022_01_19_112914_create_client_docs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (539,'2022_01_31_090302_add_missing_permissions_to_admin_role',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (540,'2022_01_31_111358_change_reference_column_to_lead_notes_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (541,'2022_02_01_104951_add_role_permissions_settings_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (542,'2022_02_01_113853_fix_permission_types',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (543,'2022_02_03_065848_add_order_notification_to_email_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (544,'2022_02_03_095618_change_quantity_type_in_order_items_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (545,'2022_02_06_150726_add_product_custom_field_group',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (546,'2022_02_07_175605_create_project_time_log_breaks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (547,'2022_02_09_084910_add_two_columns_in_sub_tasks_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (548,'2022_02_10_083543_add_description_column_to_estimates_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (549,'2022_02_11_182041_change_discussion_category_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (550,'2022_02_14_061344_add_birth_date_in_employee_detail_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (551,'2022_02_14_101407_add_data_in_dashboard_widgets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (552,'2022_02_14_133011_remove_edit_project_file_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (553,'2022_02_14_180229_make_lead_email_nullable',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (554,'2022_02_15_111216_update_notice_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (555,'2022_02_15_151924_remove_product_file_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (556,'2022_02_16_063017_add_user_notification_to_email_notification_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (557,'2022_02_16_072041_remove_lead_file_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (558,'2022_02_16_173650_add_english_language',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (559,'2022_02_17_083521_update_order_status_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (560,'2022_02_18_102942_create_emergency_contacts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (561,'2022_02_21_061830_add_emergency_contact_module_and_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (562,'2022_02_22_170153_add_item_summary_column_credit_note',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (563,'2022_02_24_070325_add_allowed_file_size_global',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (564,'2022_02_25_095712_add_discout_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (565,'2022_03_01_173825_add_approve_expense_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (566,'2022_03_03_024807_modify_signature_column_on_proposal_signs_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (567,'2022_03_04_055054_add_few_fields_in_lead_follow_up_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (568,'2022_03_07_053249_add_flutterwave_webhook_secret_hash_to_payment_gateway_credentials_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (569,'2022_03_08_063640_add_added_by_and_updated_by_columns_to_ticket_agent_groups_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (570,'2022_03_09_060457_add_several_fields_to_lead_custom_forms_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (571,'2022_03_10_094321_add_unassigned_task_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (572,'2022_03_15_104220_add_several_fields_to_invoice_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (573,'2022_03_16_060139_add_missing_hash_in_invoices_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (574,'2022_03_16_093939_change_chat_length',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (575,'2022_03_22_101553_remove_html_tags_in_products',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (576,'2022_03_28_081634_create_ticket_email_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (577,'2022_03_30_075758_add_imap_columns_tickets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (578,'2022_04_06_050532_create_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (579,'2022_04_11_094350_add_company_address_id_to_orders_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (580,'2022_04_20_173756_change_milestone_cost_limit',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (581,'2022_04_21_074927_add_currency_key_version_column',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (582,'2022_04_22_054036_add_view_earning_permission_timelogs',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (583,'2022_04_22_102709_create_employee_shifts_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (584,'2022_04_25_085447_ad_missing_admin_permissions',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (585,'2022_05_03_180927_add_soft_delete_tax',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (586,'2022_05_04_060741_fix_delete_cacade_recur_invoice',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (587,'2022_05_06_065647_create_employee_shift_change_requests_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (588,'2022_05_06_100620_add_location_column_in_attendance',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (589,'2022_05_17_095236_add_show_clock_in_button_in_attendace_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (590,'2022_05_23_062159_add_project_show_in_invoice_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (591,'2022_05_25_064410_add_column_employee_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (592,'2022_05_25_072526_add_custom_fields_id_to_lead_custom_form_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (593,'2022_05_27_002220_add_custom_fields_id_to_ticket_custom_form_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (594,'2022_05_31_070019_add_ticket_to_custom_field_groups',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (595,'2022_06_09_114831_add_view_shift_roster_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (596,'2022_06_13_084344_add_google_calender_status_to_users_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (597,'2022_06_20_102221_add_private_dashboard_type_to_dashboard_widgets_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (598,'2022_06_20_102234_add_date_in_project_milestones_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (599,'2022_06_20_202945_add_shift_time_columns_attendance_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (600,'2022_06_21_051915_add_reminder_and_send_reminder_after_column_to_invoice_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (601,'2022_06_22_072625_add_shift_time_columns_employee_shift_schedule_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (602,'2022_06_23_124453_add_default_status_in_calendar_view_employee_details_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (603,'2022_06_24_084953_add_project_id_column_to_task_label_list',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (604,'2022_06_28_045956_add_column_to_message_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (605,'2022_07_01_063756_add_app_name_column_organisation_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (606,'2022_07_01_111241_add_parent_id_column_to_teams',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (607,'2022_07_04_092625_change_date_format_in_organization_setting_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (608,'2022_07_11_051015_add_timelog_to_cutom_field_groups',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (609,'2022_07_13_115914_add_remark_column_shift',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (610,'2022_07_13_191406_add_custom_invoice_number_column_invoices',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (611,'2022_07_14_203040_remove_dashboards_employee_type',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (612,'2022_07_19_144705_add_week_timelog_widget_setting_private_dashboard',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (613,'2022_07_22_073943_update_settings_add_license_type',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (614,'2022_07_24_115433_add_expense_report_permission',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (615,'2022_07_25_122923_add_task_soft_delete',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (616,'2022_07_25_141508_add_today_attendance_widget_hr_dashbaord',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (617,'2022_07_28_043824_add_export_column_custom_fields_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (618,'2022_07_28_175448_create_knowledge_base_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (619,'2022_07_29_101111_add_indexes_to_table_columns',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (620,'2022_08_01_104602_add_columns_to_employee_details',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (621,'2022_08_02_113623_add_external_link_column_knowledge_base_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (622,'2022_08_02_121434_add_timestamps_knowledge_base_files_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (623,'2022_08_03_103344_add_auto_clock_in_column_to_attendance_settings_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (624,'2022_08_04_075744_add_approved_columns_on_leaves',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (625,'2022_08_04_122512_add_columns_in_leave_types',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (626,'2022_08_04_184937_add_half_day_type_in_leaves_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (627,'2018_01_01_000000_create_craveva_new_table',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (628,'2025_11_28_120001_create_catalog_v2_tables',2);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (629,'2019_12_14_000001_create_personal_access_tokens_table',3);

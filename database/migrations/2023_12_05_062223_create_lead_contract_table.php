    ...
    private function createTables()
    {
        ...
        foreach ($tables as $tableName) {
            if (Schema::hasTable($tableName)) {
                if (!Schema::hasColumn($tableName, 'deal_id')) {
        ...
        if (Schema::hasTable('deal_files')) {
            if (Schema::hasColumn('deal_files', 'lead_id')) {
                 try {
            ...
            if (!Schema::hasColumn('deal_files', 'deal_id')) {
                Schema::table('deal_files', function (Blueprint $table) {
                    $table->unsignedBigInteger('deal_id')->nullable()->after('lead_id');
                });
            }
            ...
            try {
                Schema::table('deal_files', function (Blueprint $table) {
                 ...
                 echo "Warning: Failed to add foreign key to deal_files: " . $e->getMessage() . "\n";
            }
        }
    }
